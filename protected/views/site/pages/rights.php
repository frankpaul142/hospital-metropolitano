	...
	<div class="contenido-interno">
        ...
        <div class="submenu-interno">
            ...
            <ul>
                ...
                <li class="selected-opc"><?php echo Yii::t('menus','submenu_derechos'); ?></li>
        ...
        <div class="contenido-pag-internas">
        	<h1><?php echo Yii::t('menus','submenu_derechos'); ?></h1>
            <img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/images/DERECHOSYOBLUGACIONES.png" />
            <?php echo Yii::t('rights','text'); ?>
        </div>
        <!-- -->
    </div>
</section>