<section class="contenido-pagina">
	<div class="contenido-interno">
        ...
        <div class="submenu-interno">
            ...
            <ul>
                <li class="selected-opc"><?php echo Yii::t('menus','submenu_historia'); ?></li>
        ...
        <div class="contenido-pag-internas">
        	<h1><?php echo Yii::t('menus','submenu_historia'); ?></h1>
            <img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/images/HISTORIA.png" />
            <span><?php echo Yii::t('history','text'); ?></span>
        </div>
        <!-- -->
    </div>
</section>