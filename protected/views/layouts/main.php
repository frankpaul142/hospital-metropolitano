...
$list = CHtml::listData($specialities, 
                'id', 'name');
...
<section id="new_p" class="banner-promo" style="display:hidden;">
	<div class="info-promo">
    	<div class="fotorama" data-width="100%" data-fit="cover" data-nav="none" data-transition="dissolve" data-loop="true" data-arrows="false" data-autoplay="7000">        	
        	<img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/images/banners/banner.jpg" alt="banners metropolitano"/>
			<img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/images/banners/banner2.jpg" alt="banners metropolitano"/>
			<img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/images/banners/banner3.jpg" alt="banners metropolitano"/>
        </div>
    </div>
