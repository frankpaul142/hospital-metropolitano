...
class Attention extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('pacient_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, pacient_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'pacient' => array(self::BELONGS_TO, 'Pacient', 'pacient_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('pacient_id',$this->pacient_id);
